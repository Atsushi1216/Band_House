...
Music.create!(:title => "オーバーフロー",:caption => "1stのdemo曲です。",:song_image => File.open('./app/assets/images/tendertemper_logo.jpg'),:song => File.open('./app/assets/musics/オーバーフロー(demo).mp3'),:user_id => "2",:evaluation => "5")
Music.create!(:title => "花言葉(demo)",:caption => "1stのdemo曲です。",:song_image => File.open('./app/assets/images/tendertemper_logo.jpg'),:song => File.open('./app/assets/musics/花言葉(demo).mp3'),:user_id => "2",:evaluation => "5")